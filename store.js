...
const DEFAULT_PRODUCTS = [
  ...
  { id:"fish-01", category:"fish", name:"Rui (Rohu)", name_bn:"রুই মাছ", unit:"kg", step:0.25, price:240, image:ph("Rui","%23C9D6DE"), inStock:true },
  { id:"fish-02", category:"fish", name:"Katla", name_bn:"কাতলা মাছ", unit:"kg", step:0.25, price:280, image:ph("Ka","%23C9D6DE"), inStock:true },
  { id:"fish-03", category:"fish", name:"Ilish (Hilsa)", name_bn:"ইলিশ মাছ", unit:"kg", step:0.25, price:1450, image:ph("Il","%23C9D6DE"), inStock:true },
  { id:"fish-04", category:"fish", name:"Chingri (Prawns)", name_bn:"চিংড়ি মাছ", unit:"kg", step:0.25, price:580, image:ph("Ch","%23C9D6DE"), inStock:true },
  { id:"fish-05", category:"fish", name:"Pabda", name_bn:"পাবদা মাছ", unit:"kg", step:0.25, price:450, image:ph("Pa","%23C9D6DE"), inStock:true },
  { id:"fish-06", category:"fish", name:"Bata", name_bn:"বাটা মাছ", unit:"kg", step:0.25, price:190, image:ph("Ba","%23C9D6DE"), inStock:false },

  // MUTTON & CHICKEN — priced per 1 Kg
  { id:"mea-01", category:"meat", name:"Mutton (Curry Cut)", name_bn:"খাসির মাংস (কারি কাট)", unit:"kg", step:0.25, price:760, image:ph("Mu","%23E9CFC4"), inStock:true },
  { id:"mea-02", category:"meat", name:"Chicken (Curry Cut)", name_bn:"মুরগির মাংস (কারি কাট)", unit:"kg", step:0.25, price:195, image:ph("Ch","%23E9CFC4"), inStock:true },
  { id:"mea-03", category:"meat", name:"Chicken Breast (Boneless)", name_bn:"মুরগির বুকের মাংস (হাড় ছাড়া)", unit:"kg", step:0.25, price:290, image:ph("Br","%23E9CFC4"), inStock:true },
  { id:"mea-04", category:"meat", name:"Country Chicken (Deshi)", name_bn:"দেশি মুরগি", unit:"kg", step:0.25, price:390, image:ph("De","%23E9CFC4"), inStock:true },

  // GROCERY — priced per 1 Kg (oil per 1 litre, since it's liquid)
  { id:"gro-01", category:"grocery", name:"Gobindobhog Rice", name_bn:"গোবিন্দভোগ চাল", unit:"kg", step:0.25, price:105, image:ph("Ri","%23E7DCC0"), inStock:true },
  { id:"gro-02", category:"grocery", name:"Masoor Dal", name_bn:"মসুর ডাল", unit:"kg", step:0.25, price:98, image:ph("Da","%23E7DCC0"), inStock:true },
  { id:"gro-03", category:"grocery", name:"Mustard Oil (Kachi Ghani)", name_bn:"সরিষার তেল (কাঁচি ঘানি)", unit:"litre", step:0.25, price:175, image:ph("Oi","%23E7DCC0"), inStock:true },
  { id:"gro-04", category:"grocery", name:"Panch Phoron", name_bn:"পাঁচ ফোড়ন", unit:"kg", step:0.25, price:520, image:ph("PP","%23E7DCC0"), inStock:true },
  { id:"gro-05", category:"grocery", name:"Ghee (Cow)", name_bn:"ঘি (গরুর)", unit:"kg", step:0.25, price:960, image:ph("Gh","%23E7DCC0"), inStock:true },

  // VEGETABLES — priced per 1 Kg
  { id:"veg-01", category:"vegetables", name:"Potato (Aloo)", name_bn:"আলু", unit:"kg", step:0.25, price:28, image:ph("Po","%23DCE7C8"), inStock:true },
  { id:"veg-02", category:"vegetables", name:"Onion (Peyaj)", name_bn:"পেঁয়াজ", unit:"kg", step:0.25, price:38, image:ph("On","%23DCE7C8"), inStock:true },
  { id:"veg-03", category:"vegetables", name:"Tomato", name_bn:"টমেটো", unit:"kg", step:0.25, price:32, image:ph("To","%23DCE7C8"), inStock:true },
  { id:"veg-04", category:"vegetables", name:"Brinjal (Begun)", name_bn:"বেগুন", unit:"kg", step:0.25, price:42, image:ph("Br","%23DCE7C8"), inStock:true },
  { id:"veg-05", category:"vegetables", name:"Cauliflower (Fulkopi)", name_bn:"ফুলকপি", unit:"kg", step:0.25, price:70, image:ph("Ca","%23DCE7C8"), inStock:true },
  { id:"veg-06", category:"vegetables", name:"Spinach (Palak Shak)", name_bn:"পালং শাক", unit:"kg", step:0.25, price:40, image:ph("Sp","%23DCE7C8"), inStock:true },
  { id:"veg-07", category:"vegetables", name:"Green Chilli (Kacha Lonka)", name_bn:"কাঁচা লঙ্কা", unit:"kg", step:0.25, price:70, image:ph("Ch","%23DCE7C8"), inStock:true },

  // SWEETS — priced per 1 Kg
  { id:"swt-01", category:"sweets", name:"Roshogolla", name_bn:"রসগোল্লা", unit:"kg", step:0.25, price:260, image:ph("Ro","%23F0DCE3"), inStock:true },
  { id:"swt-02", category:"sweets", name:"Sandesh (Kora)", name_bn:"সন্দেশ (কোরা)", unit:"kg", step:0.25, price:480, image:ph("Sa","%23F0DCE3"), inStock:true },
  { id:"swt-03", category:"sweets", name:"Mishti Doi", name_bn:"মিষ্টি দই", unit:"kg", step:0.25, price:150, image:ph("Do","%23F0DCE3"), inStock:true },
  { id:"swt-04", category:"sweets", name:"Chomchom", name_bn:"চমচম", unit:"kg", step:0.25, price:380, image:ph("Ch","%23F0DCE3"), inStock:true },
  ...
  { id:"ach-01", category:"achar", name:"Mango Achar (Aam)", name_bn:"আমের আচার", unit:"kg", step:0.25, price:320, image:ph("Aa","%23F0E2C4"), inStock:true },
  { id:"ach-02", category:"achar", name:"Mixed Vegetable Achar", name_bn:"মিশ্র সবজির আচার", unit:"kg", step:0.25, price:300, image:ph("Mi","%23F0E2C4"), inStock:true },
  { id:"ach-03", category:"achar", name:"Lime Achar (Lebu)", name_bn:"লেবুর আচার", unit:"kg", step:0.25, price:300, image:ph("Le","%23F0E2C4"), inStock:true },
  { id:"ach-04", category:"achar", name:"Hajmi Goli", name_bn:"হজমি গুলি", unit:"pack", step:1, price:25, image:ph("Ha","%23F0E2C4"), inStock:true },
  { id:"ach-05", category:"achar", name:"Aam Papad", name_bn:"আম পাপড়", unit:"kg", step:0.25, price:250, image:ph("AP","%23F0E2C4"), inStock:true },
